...
def mostrar_menu_cuenta(usuario):
    while True:
        print("\nCuenta:")
...
def mostrar_menu_principal(usuario):
    while True:
        ...
        if opcion_principal == '1':
            ...
            if mostrar_menu_cuenta(usuario):
                break  # Salir del bucle si se borra la cuenta
        elif opcion_principal == '3':
            gestionar_palabras(usuario)
...
while True:
    ...
    if opcion_principal == '1':
        ...
        if mostrar_menu_cuenta(usuario_actual):
            break  # Salir del bucle si se borra la cuenta
    elif opcion_principal == '3':
